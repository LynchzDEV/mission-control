...
describe('quiet shell', () => {
  test('/ renders the composer, toolbar controls and the usage card mount', async () => {
    ...
    for (const marker of ['id="composer"', 'id="new-chat"', 'id="new-chat-more"', 'class="split"', 'id="chip-group"', 'id="project-chip"', 'id="model-chip"', 'id="edit-chip"', 'id="project-menu"', 'id="model-menu"', 'id="open-agents"', 'id="toggle-flow"', 'id="usage-track"', 'id="live-launch" class="access-dialog flat"', 'id="rail-cards"', 'id="rail-new"', 'id="live-stage"', 'id="drop-stage"', 'id="term-park"', 'id="end-session"', 'id="end-session-confirm"', 'id="drop-over"', 'id="toast"', 'href="/quiet.css"', 'href="/studio"', 'window.MC_WORKSPACE_DIR=']) expect(markup).toContain(marker)
