...
describe('quiet shell', () => {
  ...
  test('the shell islands transpile', async () => {
    for (const island of ['shell', 'shell-composer', 'terminals', 'shell-activity', 'usage-card', 'backdrop', 'chat']) {
